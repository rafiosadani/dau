...
class Mdonatur extends CI_Model {
    ...
    public function getDonatur($limit,$offset) {
        $this->db->select('count(autoid) as tt_data,donaturbaru.kwsn, donaturbaru.noid, donaturbaru.nama, donaturbaru.status,donaturbaru.jupen, donaturbaru.alamat, donaturbaru.autoid, donaturbaru.jupen as kodejgt');
    ...
    public function getDonaturExcel() {
        $this->db->select('donaturbaru.kwsn,donaturbaru.tglm, donaturbaru.noid, donaturbaru.nama, donaturbaru.status, donaturbaru.alamat, donaturbaru.autoid, kawasan.kodejgt, kawasan.kodejgt as kdprozis ,donaturbaru.telphp as nohp,donaturbaru.status,kawasan.nm_kawasan as nama_kawasan, sum(donatur_item.besar) as donasi');
        $this->db->from('donaturbaru');
        $this->db->join('donatur_item', 'autoid = donatur_item.noid');
    ...
    public function getDonaturCab($limit,$offset) {
        $this->db->select('count(autoid) as tt_data,donaturbaru.kwsn, donaturbaru.noid, donaturbaru.nama, donaturbaru.status, donaturbaru.alamat, donaturbaru.autoid, kawasan.kodejgt');
        $this->db->from('donaturbaru');
        // $this->db->join('donatur_item', 'autoid = donatur_item.noid');
        // $this->db->join('program', 'donatur_item.prog = program.PROG');
        $this->db->join('kawasan', 'donaturbaru.kwsn = kawasan.kwsn');
    ...
    public function getDonaturUser($limit,$offset) {
        $this->db->select('count(autoid) as tt_data,donaturbaru.kwsn, donaturbaru.noid, donaturbaru.nama, donaturbaru.status, donaturbaru.alamat, donaturbaru.autoid, donaturbaru.jupen as kodejgt');
        $this->db->from('donaturbaru');
        // $this->db->join('donatur_item', 'autoid = donatur_item.noid');
        // $this->db->join('program', 'donatur_item.prog = program.PROG');
        //$this->db->join('kawasan', 'donaturbaru.kwsn = kawasan.kwsn');
    ...
    public function getKawasan($limit,$offset)
    {
        ...
        $this->db->order_by('CAST(kwsn as DECIMAL)', 'DESC');
        $this->db->limit($limit,$offset);
        return $this->db->get()->result();
    }
