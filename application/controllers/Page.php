    ...
    public function index()
    {
        if ($this->input->get('show')) {
            if ($this->session->userdata('superadmin') == TRUE) {
                ...
                $data['pekerjaan'] = $this->mpage->semuaPekerjaan();
                $data['dlain2'] = $this->mpage->donaturlain2();
                $data['ilain2'] = $this->mpage->infaqlain2();
                $data['kota'] = $this->mpage->daftarKota();
                $data['pendidikan'] = $this->mpage->daftarPendidikan();
                ...
                $data['pekerjaan'] = $this->mpage->semuaPekerjaan();
                $data['dlain2'] = $this->mpage->donaturlain2Cabang();
                $data['ilain2'] = $this->mpage->infaqlain2Cabang();
                $data['kota'] = $this->mpage->daftarKota();
                $data['pendidikan'] = $this->mpage->daftarPendidikan();
                $this->load->view('dashboard', $data);
                ...
                $data['pekerjaan'] = $this->mpage->semuaPekerjaan();
                $data['dlain2'] = $this->mpage->donaturlain2Group();
                $data['ilain2'] = $this->mpage->infaqlain2Group();
                $data['kota'] = $this->mpage->daftarKota();
                $data['pendidikan'] = $this->mpage->daftarPendidikan();
                $this->load->view('dashboard', $data);
            } else {
                ...
                $data['pekerjaan'] = $this->mpage->semuaPekerjaan();
                $data['dlain2'] = $this->mpage->donaturlain2User();
                $data['ilain2'] = $this->mpage->infaqlain2User();
                $data['kota'] = $this->mpage->daftarKota();
                $data['pendidikan'] = $this->mpage->daftarPendidikan();
                $this->load->view('dashboard', $data);
            }
