...
<html lang="en" dir="ltr">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="box-body table-responsive">
      <?php $tgl = $_GET['tgl']; ?>
      <p align="center"><b> REKAP KAWASAN KURANG TARGET <br> <span> KODE PROZIS : <?php echo $this->input->get('jungut'); ?> </span><span> PERIODE : <?php echo substr($tgl,0,10)." S/D ".substr($tgl,11,21); ?> </span><span>TANGGAL CETAK : <?php date_default_timezone_set('Asia/Jakarta'); echo date("Y-m-d h:i:s"); ?></span></b> </p>
        ...
        <?php foreach ($kwsnNol as $no => $tampil) : ?>
          <tr>
            ...
            <td><?php echo $tampil->ins_pk ?></td>
						...
						<td align="right"><?php echo $v->t_dnt?></td>
						<td align="right"><?php echo number_format($v->t_dns,0,'.','.') ?></td>
						<?php endforeach; ?>
        ...
        <?php endforeach; ?>
          <tr>
            <td colspan="3" align="center"> <b>TOTAL</b> </td>
						<?php $tot = 0; foreach ($this->mkwsn_nol->getTarget($tampil->Bulan,$tampil->tahun,$tampil->kodej,'') as $v) {
							$tot = $v->t_dnt+$tot;
						}?>
