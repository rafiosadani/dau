          ...
          <div class="col-xs-12">
            <div class="box box-info">
              <div class="box-header">
                <h3 class="box-title">report_tagih</h3>
              </div>
              <!-- /.box-header -->
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-3" style="padding-bottom:5px;" >
                        <form action="<?php echo base_url('importDB/report_tagih') ?>" id="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-1" style="padding-bottom:20px;">
                      <form action="<?php echo base_url('importdb/update') ?>" method="post">
                  ...
                  <div class="row">
                   <?php if($this->input->post('nama_file')){?>
                    <div class="col-sm-12">
                        ...
                        $lines = file(base_url('import/import_report_tagih.txt'));
