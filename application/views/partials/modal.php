    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label for="modal-program-slipmanual" class="control-label">Jungut</label>
            <select class="form-control selectpicker" id="jungut-slipbaru-slipmanual" name="kodej" data-live-search="true">
          ...
          <label for="modal-noslip" class="control-label">Tanggal Penghimpunan</label>
            <input id="modal-date-slipbaru-slipmanual" type="text" class="form-control" name="noslip" >
          </div>
        <div class="form-group">
        <label for="modal-program-slipmanual" class="control-label">Program</label>
            <select class="form-control selectpicker" id="program-slipbaru-slipmanual" name="kodej" data-live-search="true">
              <option name="prog" value="">pilih data</option>
          ...
          <label for="modal-noslip" class="control-label">Jumlah</label>
            <input id="modal-jumlah-slipbaru-slipmanual" type="number" class="form-control" name="noslip" >
          </div>
          <div class="form-group">
        <label for="modal-program-slipmanual" class="control-label">Bank</label>
            <select class="form-control selectpicker" id="bank-slipbaru-slipmanual" name="kodej" data-live-search="true">
          ...
          <label for="modal-noslip" class="control-label">No Kasir</label>
            <input id="modal-nokasir-slipbaru-slipmanual" type="text" class="form-control" name="noslip" >
          </div>
          <div class="form-group">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        <button type="button" id="btn-tambah-slipbaru-slipmanual" class="btn btn-success">Simpan</button>
      </div></form>
    </div>
    <!-- /.modal-content -->
  </div>
      ...
      <div class="modal-body">
        ...
        <label for="nama" class="control-label">Nama Lengkap</label>
          ...
          <div class="form-group">
            ...
            <select id="prov" class="form-control selectpicker" name="prov" data-live-search="true">
              <option name="prov" value=""> - </option>
              <?php foreach($prov as $prov) : ?>
                <option name="prov" class="mdl" value="<?php echo $prov->IDPROP ?>"><?php echo $prov->NAMA ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            <label for="kota" class="control-label">Kota</label>
              <select class="form-control" id="kota"  data-live-search="true" name="kota">
                <option value="">-</option>
              </select>
          </div>
          <div class="form-group">
            <label for="kec" class="control-label">Kecamatan</label>
            <select id="kecamatan" class="form-control" name="kec" data-live-search="true">
              <option value="">-</option>
            </select>
          </div>
          <div class="form-group">
            <label for="desa" class="control-label">Desa</label>
            <select id="desa" class="form-control" name="desa" data-live-search="true">
              <option value="">-</option>
            </select>
          </div>
        ...
        <div class="form-group">
            ...
            <label for="proza" class="control-label">Proza</label>
            <select id="proza" class="form-control selectpicker" name="proza" data-live-search="true">
              <option name="proza" value=""> - </option>
              <?php foreach($proza as $petugas) : ?>
                <option  name="proza" value="<?php echo $petugas->kodej ?>"><?php echo $petugas->kodej.' - '.$petugas->name ?></option>
              <?php endforeach; ?>
            </select>
