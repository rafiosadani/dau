    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Rekap Harian Prozis</li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box box-info">
              ...
              <div class="form-group">
                  <div class="col-sm-5">
                    <label for="kodej" class="control-label">Prozis<span style="color: red"> *</span></label>
                    <select class="form-control selectpicker" name="kodej" data-live-search="true">
                      ...
                      <?php if ($this->session->userdata('superadmin') == TRUE || $this->session->userdata('admin_grup') == TRUE) : ?>
                        <option name="kodej" value="-">SEMUA PROZIS</option>
                      <?php endif; ?>
