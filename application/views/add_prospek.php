    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Prospek Baru</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <!-- /.row -->
        <!-- Main row -->
        <form class="form-horizontal" action="<?php echo base_url("prospek/baru") ?>" method="post">
          <div class="row">
            <div class="col-xs-12">
              ...
              <input type="hidden" name="info" value="<?= $this->input->get('new')?>">
							
						<input type="text" class="form-control" name="prospek" id="prospek" required>
					</div>
				  </div>
				  <div class="col-sm-3" style="padding-top:27px;">
				  	<input type="submit" name="submit" class="btn btn-info" value="Add Prospek" />
				  </div>
				</div>
              </div>
