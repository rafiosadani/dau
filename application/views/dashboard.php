      ...
      <!-- /.row -->
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <p class="right">Tidak Terdefinisi : 
                <?php foreach($unknownAktifUmur as $un){
                  if ($un->Total=="0") {
        ...
        <div class="row">
          ...
          <div class="box box-primary">
              <div class="box-header with-border">
               <h3 class="box-title">Survey Donatur Berdasarkan Pekerjaan</h3>
               <div class="box-tools pull-right">
              ...
              <div id="kerja" style="height:auto;width:auto;position:relative; "></div>
              <script type="text/javascript">
                var chart = Highcharts.chart('kerja', {
                  chart: {
              ...
              title: {
                ...
                tooltip: {
        pointFormat: 'Donatur : <b>{point.y}</b><br/>Total Infaq : <b>Rp. {point.y1:,.0f}</b>'
    },
          plotOptions: {
        column: {
...
categories: [<?foreach ($pekerjaan as $value) { echo "'".$value->NM_PEKERJAAN."',"; }?>'LAIN - LAIN']
    ...
    <?},?>{   
                ...
                pointWidth: 50,
                  data: [
                    <?foreach ($pekerjaan as $value) {?>
                 {  name:'<?= $value->NM_PEKERJAAN?>',y: <?php foreach($this->mpage->donatur_pekerjaan($value->PEKERJAAN) as $tampil){ if ($tampil->donatur == '') { echo '0';}else {echo $tampil->donatur;} } ?> ,
                      y1: <?php foreach($this->mpage->infaq_pekerjaan($value->PEKERJAAN) as $tampil){ if ($tampil->infaq == '') { echo '0';}else {echo $tampil->infaq;} } ?>},                
                      <?}?>
                      {name:'LAIN - LAIN',y: <?php foreach($dlain2 as $tampil){ if ($tampil->donatur == '') { echo '0';}else {echo $tampil->donatur;} } ?>,
                      y1: <?php foreach($ilain2 as $tampil){ if ($tampil->infaq == '') { echo '0';}else {echo $tampil->infaq;} } ?>},
                    ],
    ...
    <?}?>
        ...
        <div class="row">
          ...
          <div class="box box-primary">
              <div class="box-header with-border">
               <h3 class="box-title">Survey Donatur Berdasarkan Kabupaten / Kota</h3>
               <div class="box-tools pull-right">
              ...
              <script src="https://code.highcharts.com/highcharts-more.js"></script>
              <script src="https://code.highcharts.com/modules/exporting.js"></script>
              <div id="kota" style="height:auto;width:auto;position:relative; "></div>
              <script type="text/javascript">
                var chart = Highcharts.chart('kota', {
                  chart: {
                    plotBackgroundColor: null,
                    plotBorderWidth: null,
                    plotShadow: false,
...
categories: [<?foreach ($kota as $value) { echo "'".$value->Kota."',"; }?>]
                 ...
                 
              {
                ...
                pointWidth: 40,
                  data: [
                    <?foreach ($kota as $value) {?>
                  { name:'<?= $value->Kota?>',y: <?php foreach($this->mpage->donaturKota($value->desaid) as $tampil){ if ($tampil->donatur == '') { echo '0';}else {echo $tampil->donatur;} } ?> ,
                      y1: <?php foreach($this->mpage->infaqKota($value->desaid) as $tampil){ if ($tampil->infaq == '') { echo '0';}else {echo $tampil->infaq;} } ?>},                
                      <?}?>
                  ],
    ...
    <?}?>
          ...
          <div class="box box-primary">
              <div class="box-header with-border">
               <h3 class="box-title">Survey Donatur Berdasarkan Pendidikan</h3>
               <div class="box-tools pull-right">
              ...
              <script src="https://code.highcharts.com/highcharts-more.js"></script>
              <script src="https://code.highcharts.com/modules/exporting.js"></script>
              <div id="pendidikan" style="height:auto;width:auto;position:relative; "></div>
              <script type="text/javascript">
                var chart = Highcharts.chart('pendidikan', {
                  chart: {
                    plotBackgroundColor: null,
                    plotBorderWidth: null,
                    plotShadow: false,
...
categories: [<?foreach ($pendidikan as $value) { echo "'".$value->pendidikan."',"; }?>]
    ...
    <?}?>         
                ...
                pointWidth: 60,
                  data: [
                    <?foreach ($pendidikan as $value) {?>
                 {  name:'<?= $value->pendidikan?>',y: <?php foreach($this->mpage->donaturPendidikan($value->pendidikanid) as $tampil){ if ($tampil->donatur == '') { echo '0';}else {echo $tampil->donatur;} } ?> ,
                      y1: <?php foreach($this->mpage->infaqPendidikan($value->pendidikanid) as $tampil){ if ($tampil->infaq == '') { echo '0';}else {echo $tampil->infaq;} } ?>},                
                      <?}?>
                    ],
      ...
      <?php }else {?>
        <section class="content-header">
            <h1>
              ...
              <small>Control panel</small>
              <span align="right">
                <button type="submit" name="show" id="show" class="btn-sm btn-primary" value=" "> Show Dashboard <span class="fa fa-angle-double-down"></span></button>
              </span>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
