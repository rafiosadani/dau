                    ...
                    <?php } ?>
                      ...
                      <div style="background-color: #f0ff91">
                        ...
                        <div class="form-group">
                          <?php if ($this->session->userdata('admin') == TRUE) : ?>
                          <div class="col-sm-5">
                          <label for="jupen" class="control-label">Proza<span style="color: red"> *</span></label>
                          <select class="form-control selectpicker" name="jupen" data-live-search="true" required id="jupen">
                            <?php foreach($jungut as $kodej) : ?>
                              <option name="program" value="<?php echo $kodej->kodej ?>"><?php echo $kodej->kodej." - ".$kodej->name ?></option>
                            <?php endforeach; ?>
                          </select></div>
                          <?php endif; ?>
                      </div>
                    ...
                    <div class="tab-pane" id="tab_3">
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <label for="info" class="control-label">Prospek By</label>
   ...
   $(document).ready(function() {
     ...
     $("select#kota").change(function() {
       ...
       $.ajax({
         ...
         success : function(data){
           for (var i=0;i<data.length;i++) {
             cont += '<option n value="'+data[i].IDKEC+'">'+data[i].NAMA+'</option>';
           };
           $('#kecamatan').html(cont);
     ...
     $("select#kecamatan").change(function() {
       ...
       $.ajax({
         ...
         success : function(data){
           for (var i=0;i<data.length;i++) {
             cont += '<option n value="'+data[i].IDDESA+'">'+data[i].NAMA+'</option>';
           };
           $('#desa').html(cont);
 ...
 <script>
   $(document).ready(function() {
     ...
     $.ajax({
       ...
       success : function(data){
         for (var i=0;i<data.length;i++) {
           cont_kabkot += '<option  value="'+data[i].IDKAB+'">'+data[i].NAMA+'</option>';
         }
         ...
         $.ajax({
           ...
           success : function(data){
             for (var i=0;i<data.length;i++) {
               cont_kec += '<option value="'+data[i].IDKEC+'">'+data[i].NAMA+'</option>';
             };
             ...
             $.ajax({
               ...
               success : function(data){
                 for (var i=0;i<data.length;i++) {
                   cont_kel += '<option n value="'+data[i].IDDESA+'">'+data[i].NAMA+'</option>';
                 };
