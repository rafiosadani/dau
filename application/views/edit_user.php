                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-5">
                                            ...
                                            <select class="form-control selectpicker" name="idcabang" required data-live-search="true" id="id_cab">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="kodej" class="control-label">Kode Prozis</label>
...
$('select#id_cab').selectpicker("val" , '<?php echo $user->idcabang ?>');
</script>
<!-- <script>
  $(function () {
    $('#example1').DataTable()
